  ...
  return (
    <Layout>
      ...
      <Article content={{ title: "Support us" }}>
        <div>
          <p>
            Your contribution will change the lives of many children who have
            very few opportunities. Please help us in providing life's most
            basic necessities to those who have so little. We are very grateful
            for those friends who have already generously taken the time to make
            ...
            support will make education possible for the underprivileged
            children in the Himalayan region. You may sponsor a child for one
            year, four years, or even eight years, depending on their program
            and your ability to provide funding.
          </p>
          <p>
            Delek Children's Foundation is a 501(c)(3) charitable non-profit
            organization dedicated to help underprivileged children go to
            school. All donations are fully tax-deductible. Ven Donyo thank
            those supporters who are making monthly donations to help us with
            our projects. General donations for The Delek Children's Foundation
          ...
          <li>
            ...
            provided for these children. Each student needs help for four years
            to graduate and be prepared for college.You may sponsor a child for
            one year, four years, or even eight years, depending on their
            program and your ability to provide funding.
          </li>
          <li>
            ...
            home and search for manual labor jobs outside their village when
            they are young teenagers.Your support will make education possible
            for so many children in the Himalayan areas of India, Nepal, and
            Bhutan and enable these children to contribute to society and make a
            difference for future generations.Delek Children's Foundation has a
            policy of not disclosing information about its donors to the public
            or any other entity. As required by the Federal Government we do
            disclose the names of donors above a certain level, but will not
            disclose contact or any other personally identifiable information
            without the donor's express permission.
          </li>
          <div
            style={{
              height: 50,
          ...
          <div>
            ...
            >
              <img
                width="335"
                src="https://cdn-images-1.medium.com/max/1575/1*8oAXoONZd2i9Pf4oVZGFsw.png"
              />
            </a>
          </div>
          <div
